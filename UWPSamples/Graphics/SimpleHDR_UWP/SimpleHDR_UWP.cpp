...
void Sample::PrepareSwapChainBuffer()
{
    ...
    PIXBeginEvent(context, PIX_COLOR_DEFAULT, L"PrepareSwapChainBuffer");
...
void Sample::RenderHDRScene()
{
    ...
    PIXBeginEvent(context, PIX_COLOR_DEFAULT, L"RenderHDRScene");
...
{
    auto context = m_deviceResources->GetD3DDeviceContext();
    PIXBeginEvent(context, PIX_COLOR_DEFAULT, L"Render2084Curve");
...
{
    auto context = m_deviceResources->GetD3DDeviceContext();
    PIXBeginEvent(context, PIX_COLOR_DEFAULT, L"RenderUI");
