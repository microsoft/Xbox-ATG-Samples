//
// DeviceResourcesXbox.cpp - A wrapper for the Direct3D 11 device and swapchain
...
DeviceResources::DeviceResources(DXGI_FORMAT backBufferFormat, DXGI_FORMAT depthBufferFormat, UINT backBufferCount, bool fastSemantics) :
    m_screenViewport{},
...
{
    if (m_fastSemantics && decompressFlags)
    {
