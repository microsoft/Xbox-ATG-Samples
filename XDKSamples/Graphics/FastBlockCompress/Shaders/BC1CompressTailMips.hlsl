...
//
// Fast block compression ComputeShader for BC1 for the mipmap "tails"
//
...
RWTexture2D<uint2> g_tex16Out : register(u0);    // Output BC1 texture as R32G32_UINT
RWTexture2D<uint2> g_tex8Out : register(u1);
RWTexture2D<uint2> g_tex4Out : register(u2);
RWTexture2D<uint2> g_tex2Out : register(u3);
RWTexture2D<uint2> g_tex1Out : register(u4);
