...
//
// This version has been modified to use CompleteFrame/MoveToNextFrame instead of Present
...
namespace DX
{
    ...
    public:
        ...
        void CompleteFrame(D3D12_RESOURCE_STATES beforeState = D3D12_RESOURCE_STATE_RENDER_TARGET);
