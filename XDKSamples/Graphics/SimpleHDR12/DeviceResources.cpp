...
void DeviceResources::CreateDeviceResources()
{
    ...
    rtvDescriptorHeapDesc.NumDescriptors = m_backBufferCount * RTVDescriptors::Count;
...
void DeviceResources::CreateWindowSizeDependentResources()
{
    ...
    else
    {
        ...
        // HDR: The HDR10 swapchain buffer needs to use the ST.2084 curve with Rec.2020 color primaries.
        ...
        ThrowIfFailed(dxgiFactory->CreateSwapChainForCoreWindow(
            ...
            &swapChainDesc,
            nullptr,
            m_swapChainHDR10.ReleaseAndGetAddressOf()
            ));
    }
    ...
    else
    {
        ...
        // HDR: Create GameDVR SDR swpachain.
        DXGI_SWAP_CHAIN_DESC1 swapChainDesc = {};
        swapChainDesc.Width = backBufferWidth;
        swapChainDesc.Height = backBufferHeight;
        swapChainDesc.BufferUsage = DXGI_USAGE_RENDER_TARGET_OUTPUT;
        ...
        ThrowIfFailed(dxgiFactory->CreateSwapChainForCoreWindow(
            ...
            &swapChainDesc,
            nullptr,
            m_swapChainGameDVR.ReleaseAndGetAddressOf()
        ));
    }
    ...
    for (UINT n = 0; n < m_backBufferCount; n++)
    {
        ...
        ThrowIfFailed(m_swapChainHDR10->GetBuffer(n, IID_GRAPHICS_PPV_ARGS(m_renderTargetsHDR10[n].GetAddressOf())));

        wchar_t name[25] = {};
        swprintf_s(name, L"HDR10 Render target %u", n);
        m_renderTargetsHDR10[n]->SetName(name);
        
        D3D12_RENDER_TARGET_VIEW_DESC rtvDesc = {};
        rtvDesc.Format = DXGI_FORMAT_R10G10B10A2_UNORM;
        rtvDesc.ViewDimension = D3D12_RTV_DIMENSION_TEXTURE2D;
        
        CD3DX12_CPU_DESCRIPTOR_HANDLE rtvDescriptorHDR10(m_rtvDescriptorHeap->GetCPUDescriptorHandleForHeapStart(), (n * RTVDescriptors::Count) + RTVDescriptors::HDR10, m_rtvDescriptorSize);
        m_d3dDevice->CreateRenderTargetView(m_renderTargetsHDR10[n].Get(), &rtvDesc, rtvDescriptorHDR10);
        ...
        CD3DX12_CPU_DESCRIPTOR_HANDLE rtvDescriptorGameDVR(m_rtvDescriptorHeap->GetCPUDescriptorHandleForHeapStart(), (n * RTVDescriptors::Count) + RTVDescriptors::GameDVR, m_rtvDescriptorSize);
...
void DeviceResources::Prepare(D3D12_RESOURCE_STATES beforeState)
{
    ...
    if (beforeState != D3D12_RESOURCE_STATE_RENDER_TARGET)
    {
        ...
        {
            CD3DX12_RESOURCE_BARRIER::Transition(m_renderTargetsHDR10[m_backBufferIndex].Get(), beforeState, D3D12_RESOURCE_STATE_RENDER_TARGET),
...
void DeviceResources::Present(D3D12_RESOURCE_STATES beforeState, bool isTVInHDRMode)
{
    if (beforeState != D3D12_RESOURCE_STATE_PRESENT)
    {
        ...
        D3D12_RESOURCE_BARRIER barriers[2] =
        {
            CD3DX12_RESOURCE_BARRIER::Transition(m_renderTargetsHDR10[m_backBufferIndex].Get(), beforeState, D3D12_RESOURCE_STATE_PRESENT),
    ...
    if (isTVInHDRMode)
    {
        // When TV is in HDR mode, we present two swapchain buffers, one for HDR10 and the other an SDR image for GameDVR/screenshots
