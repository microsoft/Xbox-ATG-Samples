...
NOTICE: this file has a single change from the default Zopfli implementation to allow it to be 
compatible with the Xbox One hardware decompression module.  The window size is reduced to 4K.
*/
...
speed.
*/
// ATG_CHANGE : BEGIN - hardware module has a 4k window limitation
#define ZOPFLI_WINDOW_SIZE 4096
// ATG_CHANGE : END
